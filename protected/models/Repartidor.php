 ...
 *
 * The followings are the available columns in table 'REPARTIDOR':
 ...
 */
class Repartidor extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('RUT_PERSONAL, ESTADO_REPARTIDOR', 'length', 'max'=>15),
			...
			array('RUT_PERSONAL, ID_SUCURSAL, NOMBRE_PERSONAL, PATERNO_PERSONAL, MATERNO_PERSONAL, CONTRASENA_PERSONAL, SEXO_PERSONAL, TELEFONO_PERSONAL, DIRECCION_PERSONAL, EMAIL_PERSONAL, AUTORIZADO_PERSONAL, CARGO_PERSONAL, ESTADO_REPARTIDOR', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'ESTADO_REPARTIDOR' => 'Estado Repartidor',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('ESTADO_REPARTIDOR',$this->ESTADO_REPARTIDOR,true);
	 ...
	 * @return Repartidor the static model class
	 */
