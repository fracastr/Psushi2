...
/**
 * This is the model class for table "ENCARGADO_COCINA".
 *
 * The followings are the available columns in table 'ENCARGADO_COCINA':
 ...
 */
class Encargado_cocina extends CActiveRecord
{
	/**
	 ...
	 * @return Encargado_cocina the static model class
	 */
