		...
		if(isset($_POST['Personal']))
		{
			...
			try{
				...
				if($model->save()){
					...
					/*
					$model2 = Personal::model()->findByPk($model->RUT_PERSONAL);						
					if(!empty($uploadFile)) {
						$extUploadFile = substr($uploadFile, strrpos($uploadFile, '.')+1);
						if(!empty($uploadFile)) {
							if($uploadFile->saveAs(Yii::app()->basePath.DIRECTORY_SEPARATOR.'files'.DIRECTORY_SEPARATOR.'personal'.DIRECTORY_SEPARATOR.$model2->RUT_PERSONAL.DIRECTORY_SEPARATOR.$model2->RUT_PERSONAL.'.'.$extUploadFile)){
		...
		if(isset($_POST['Personal']))
		{
			...
			try{
				...
				if(!empty($uploadFile)) {
					$extUploadFile = substr($uploadFile, strrpos($uploadFile, '.')+1);
					if(!empty($uploadFile)) {
						if($uploadFile->saveAs(Yii::app()->basePath.DIRECTORY_SEPARATOR.'files'.DIRECTORY_SEPARATOR.'personal'.DIRECTORY_SEPARATOR.$model->RUT_PERSONAL.DIRECTORY_SEPARATOR.$model->RUT_PERSONAL.'.'.$extUploadFile)){
