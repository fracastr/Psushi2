...
<table>
	...
	<tr>
		...
		<td WIDTH=200>Ingreso Autorizado<?php echo $form->checkBox($model,'AUTORIZADO_PERSONAL',array('class'=>'span5','maxlength'=>2, 'style'=> 'width:20px','value'=>'Si', 'uncheckValue'=>'No')); ?></td>
