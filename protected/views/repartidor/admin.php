<?php
/* @var $this RepartidorController */
/* @var $model Repartidor */

$this->breadcrumbs=array(
	'Repartidors'=>array('index'),
	'Manage',
);
...
$this->menu=array(
	array('label'=>'Repartidor','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
$('.search-form form').submit(function(){
	$('#repartidor-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
/*
			array(
		        'header' => 'ESTADO_REPARTIDOR',
		        'name'=> 'ESTADO_REPARTIDOR',
		        'type'=>'raw',
		        'value' => '($data->ESTADO_REPARTIDOR)',
		        'class' => 'bootstrap.widgets.TbEditableColumn',
	            'headerHtmlOptions' => array('style' => 'text-align:center'),
				'editable' => array(
					'type'    => 'textarea',
