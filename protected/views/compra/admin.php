...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
			...
			array(
		        'header' => 'ID_BOLETA_COMPRA',
		        'name'=> 'ID_BOLETA_COMPRA',
		        'type'=>'raw',
		        'value' => '($data->ID_BOLETA_COMPRA)',
		        'class' => 'bootstrap.widgets.TbEditableColumn',
	            'headerHtmlOptions' => array('style' => 'text-align:center'),
				'editable' => array(
					'type'    => 'textarea',
			...
			array(
		        'header' => 'FECHA_HORA_COMPRA',
		        'name'=> 'FECHA_HORA_COMPRA',
		        'type'=>'raw',
		        'value' => '($data->FECHA_HORA_COMPRA)',
		        'class' => 'bootstrap.widgets.TbEditableColumn',
	            'headerHtmlOptions' => array('style' => 'text-align:center'),
				'editable' => array(
					'type'    => 'textarea',
			...
			array(
		        'header' => 'DINERO_COMPRA',
		        'name'=> 'DINERO_COMPRA',
		        'type'=>'raw',
		        'value' => '($data->DINERO_COMPRA)',
		        'class' => 'bootstrap.widgets.TbEditableColumn',
	            'headerHtmlOptions' => array('style' => 'text-align:center'),
				'editable' => array(
					'type'    => 'textarea',
...
/*
			array(
		        'header' => 'ESTADO_COMPRA',
		        'name'=> 'ESTADO_COMPRA',
		        'type'=>'raw',
		        'value' => '($data->ESTADO_COMPRA)',
		        'class' => 'bootstrap.widgets.TbEditableColumn',
	            'headerHtmlOptions' => array('style' => 'text-align:center'),
				'editable' => array(
					'type'    => 'textarea',
	    ...
	    */
	    array(
            ...
            (
                'view' => array
                (    
                	'url' => '$data->ID_COMPRA."|".$data->ID_COMPRA',              
                	'click' => 'function(){
